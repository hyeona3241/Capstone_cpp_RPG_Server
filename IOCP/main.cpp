...
//    {
//        std::printf("[ERROR] Failed to start LoginServer.\n");
//        dbServer.StopServer();
//        return 1;
//    }
//
//    std::printf("[INFO] LoginServer started. Listening on port %u.\n", loginPort);
//
//    // LoginServer가 먼저 떠야 하므로 잠깐 대기
//    std::this_thread::sleep_for(std::chrono::milliseconds(300));
//
//    // =========================
//    // MainServer 생성 & 실행
...
//
//    // =========================
//    // MainServer → LoginServer 연결
//    // =========================
//    if (!mainServer.ConnectToLoginServer("127.0.0.1", loginPort))
//    {
//        std::printf("[ERROR] MainServer failed to connect to LoginServer.\n");
//        mainServer.Stop();
...
//    }
//
//    std::printf("[INFO] MainServer connected to LoginServer.\n");
//
//
//    // =========================
//    // 루프
